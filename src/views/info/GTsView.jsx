...
import { BookOpen, ExternalLink, Send, Info, Award, Calendar, MapPin, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div style={{ background: '#F7F8FA', minHeight: '100vh' }}>
      <header style={{ 
        ...
        <h2 style={{ fontSize: '18px', fontWeight: '800', fontFamily: 'var(--font-serif)', color: 'white', margin: 0 }}>Revista e GTs</h2>
      </header>
      ...
      <div style={{ padding: 'calc(env(safe-area-inset-top, 24px) + 70px) 20px 100px' }}>
        ...
        <div style={{ marginBottom: '32px', textAlign: 'left' }}>
           <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '24px', fontWeight: '900', color: 'var(--primary)' }}>Chamada de Trabalhos</h2>
           <p style={{ fontSize: '12px', color: 'var(--text-muted)', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px' }}>Submissões II CIECC 2026</p>
        </div>
