        ...
        <div className="strategic-dashboard fade-in">
            ...
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '32px', flexWrap: 'wrap', gap: '20px' }}>
                <div>
                   ...
                   <h2 style={{ fontSize: '32px', fontWeight: '900', color: 'white', letterSpacing: '-1px' }}>Painel Estratégico & Auditoria</h2>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px', marginBottom: '24px' }}>
                <div style={{ background: 'linear-gradient(135deg, #4A101D 0%, #6B141A 100%)', borderRadius: '20px', padding: '28px', border: '1px solid rgba(212,193,156,0.3)' }}>
                    ...
                    <p style={{ fontSize: '56px', fontWeight: '900', color: '#D4C19C', lineHeight: 1, marginBottom: '6px' }}>{rawData.membersCount.toLocaleString('pt-BR')}</p>
                    <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)' }}>Participantes cadastrados no sistema</p>
                </div>
                <div style={{ background: 'linear-gradient(135deg, #0F172A 0%, #1E293B 100%)', borderRadius: '20px', padding: '28px', border: '1px solid rgba(212,193,156,0.3)' }}>
                    ...
                    <p style={{ fontSize: '56px', fontWeight: '900', color: '#D4C19C', lineHeight: 1, marginBottom: '6px' }}>{ticketCounts.presencial.toLocaleString('pt-BR')}</p>
                    <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)' }}>Com ingresso presencial</p>
                </div>
                <div style={{ background: 'linear-gradient(135deg, #1E3A5F 0%, #1E293B 100%)', borderRadius: '20px', padding: '28px', border: '1px solid rgba(212,193,156,0.3)' }}>
                    ...
                    <p style={{ fontSize: '56px', fontWeight: '900', color: '#D4C19C', lineHeight: 1, marginBottom: '6px' }}>{ticketCounts.online.toLocaleString('pt-BR')}</p>
